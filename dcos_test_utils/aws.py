...
OS_AMIS = {
    'centos': {'ap-northeast-1': 'ami-965345f8',
    ...
    'centos-7-dcos-prereqs': {'ap-northeast-1': 'ami-5942133e',
    ...
    'debian': {'ap-northeast-1': 'ami-fe54f3fe',
    ...
    'rhel': {'ap-northeast-1': 'ami-35556534',
    ...
    'ubuntu': {'ap-northeast-1': 'ami-0919cd68',
